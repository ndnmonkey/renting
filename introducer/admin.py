...
class HouseManager(admin.ModelAdmin):
    # 展示字段
    list_display = ['housename', 'community', 'describe', 'price', 'housearea', 'address', 'floor', 'building_age',
                    'house_type', 'surrounding_facilities', 'is_delete', 'shelf_status', 'create_time', 'update_time']
    # 查询字段
    search_fields = ['housename']
    # 过滤字段(右侧展示)
    list_filter = ['housename', 'community', 'price', 'housearea', 'address', 'building_age', 'house_type']
    # 分页，分页框会出现在下侧
    list_per_page = 10
